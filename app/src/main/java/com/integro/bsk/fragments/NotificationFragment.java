...
import com.integro.bsk.adapters.NotificationAdapter;
import com.integro.bsk.api.ApiClients;
import com.integro.bsk.api.ApiServices;
import com.integro.bsk.model.Notification;
    ...
    public void getNotificationList() {
        ...
        notificationListCall.enqueue(new Callback<NotificationList>() {
            ...
            public void onResponse(Call<NotificationList> call, Response<NotificationList> response) {
                ...
                Log.d("RESPONSE", "" + response.body().getNotificationArrayList().size());
                notificationArrayList.addAll(response.body().getNotificationArrayList());
                adapter = new NotificationAdapter(getContext(), notificationArrayList);
                rvnotification.setAdapter(adapter);
                adapter.notifyDataSetChanged();*/
